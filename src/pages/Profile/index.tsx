...
const ProfileView = () => {
    ...
    const { mutate: handleLogOut } = useMutation({ mutationKey: ["logout"], mutationFn: logout, onSuccess: () => navigate("/login") })
        ...
        <div className="h-[100vh] flex flex-col items-center justify-center">
            <div className="w-[500px] flex flex-col gap-4">
                ...
                <Input
                    placeholder="სახელი"
                    value={nameKa}
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setNameKa(e.target.value)}
                />
                <button className='text-xl font-bold ' onClick={handleGenerateAvatar}>Generate Avatar</button>
                ...
                {profile && (
                    <div className="mt-6 p-4 border rounded bg-gray-100 flex flex-col items-center justify-center">
                        ...
                        <div className='flex gap-8'>
                            <p onClick={handleChangeprofile} className='text-green-600 cursor-pointer'>Change Profile</p>
                            <p className='text-red-600 cursor-pointer' onClick={()=>handleLogOut()}>Log Out</p>
                        </div>
